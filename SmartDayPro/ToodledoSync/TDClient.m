...
- (void)fetchData:(TDFetchParam *)param delegate:(id)delegate didFinishSelector:(SEL)finishedSEL didFailSelector:(SEL)failedSEL userInfo:(NSObject *)usrInfo
{
    ...
    switch (param.command)
    {
        case FETCH_USER_ID:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/account/lookup.php?f=xml;"];
        }
            break;
        case FETCH_TOKEN:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/account/token.php?f=xml;"];
        }
            break;
        case FETCH_ALL_FOLDER:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/folders/get.php?f=xml;"];
        }
            break;
        case FETCH_ADD_FOLDER:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/folders/add.php?f=xml;fields=folder,meta;"];
        }
            break;
        case FETCH_EDIT_FOLDER:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/folders/edit.php?f=xml;"];
        }
            break;
        case FETCH_DELETE_FOLDER:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/folders/delete.php?f=xml;"];
        }
            break;
        case FETCH_TASK:
        {
            ...
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/tasks/get.php?f=xml;fields=%@;", [TDSync encodeString:fields]];
        }
            break;
        case FETCH_ACCOUNT:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/account/get.php?f=xml;"];
        }
            break;
        case FETCH_ADD_TASK:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/tasks/add.php?f=xml;fields=folder,star,meta;"];
        ...
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/tasks/edit.php?f=xml;fields=folder,star;"];
        ...
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/tasks/deleted.php?f=xml;"];
        }
            break;
        case FETCH_DELETE_TASK:
        {
            url = [NSString stringWithFormat:@"https://api.toodledo.com/2/tasks/delete.php?f=xml;"];
