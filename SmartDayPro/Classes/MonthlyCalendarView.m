...
{
    //printf("update busy time from:%s - to:%s\n", [[fromDate description] UTF8String], [[toDate description] UTF8String]);
    
    //NSLog(@"*** start update busy time");
...
- (void)showWeekCalendar:(NSDate *)date
{
    ...
    //printf("Show Calendar - start:%s, last:%s, from:%s, to:%s\n", [[startDate description] UTF8String], [[lastDate description] UTF8String], [[fromDate description] UTF8String], [[toDate description] UTF8String]);
