...
//            color = [UIColor colorWithRed:237.0/255 green:237.0/255 blue:237.0/255 alpha:1];
		...
		else if (freeRatio < 0.25)
		{
            ...
            color = [UIColor colorWithRed:212.0/255 green:212.0/255 blue:212.0/255 alpha:1];
		}
		else if (freeRatio < 0.5)
		{
			//color = [UIColor colorWithRed:156.0/255 green:151.0/255 blue:164.0/255 alpha:1];
            color = [UIColor colorWithRed:186.0/255 green:186.0/255 blue:186.0/255 alpha:1];
		}
		else if (freeRatio < 0.75)
		{
			//color = [UIColor colorWithRed:136.0/255 green:131.0/255 blue:144.0/255 alpha:1];
            color = [UIColor colorWithRed:161.0/255 green:161.0/255 blue:161.0/255 alpha:1];
		}
		else
		{
			//color = [UIColor colorWithRed:116.0/255 green:111.0/255 blue:124.0/255 alpha:1];
            color = [UIColor colorWithRed:135.0/255 green:135.0/255 blue:135.0/255 alpha:1];
		}		
	}
	else
	{
