...
#define FONT_SIZE_PLACEHOLDER 16
...
#define HEIGHT_SEPARATOR_CELL 0.5
#define SIZE_ICON_PREVIEW 16
...
typedef enum
{
    ...
    PROJECT_EXTRA_STATUS_PENDING = 1,
    PROJECT_EXTRA_STATUS_ACCEPTED = 2,
    PROJECT_EXTRA_STATUS_OWNER = 4
} ProjectExtraStatus;
