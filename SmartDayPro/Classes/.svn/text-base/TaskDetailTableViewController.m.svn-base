...
- (void)save:(id) sender
{
    ...
    else 
    {
        ...
        else
        {
            ...
            if (reEdit)
            {
                //recover the RE original time not Instance time to update RE correctly
                self.taskCopy.startTime = self.task.original.startTime;
                self.taskCopy.endTime = self.task.original.endTime;
            }
            */
