...
+(UIColor *)darkSteelBlue;				//	20-80-130	145082 
{
...
+(UIColor *)darkBrown;					//	92-64-51	5c4033	 
{
	return [UIColor colorWithRed:92.0/255 green:64.0/255 blue:51.0/255 alpha:1];
}

+(UIColor *)scarlet;				//	140-23-23	8c1717	
{
	return [UIColor colorWithRed:140.0/255 green:23.0/255 blue:23.0/255 alpha:1];
}

+(UIColor *)darkScarlet;			//	118-19-19	761313
{
	return [UIColor colorWithRed:118.0/255 green:19.0/255 blue:19.0/255 alpha:1];
}

+(UIColor *)lightScarlet;			//	162-26-26	A21A1A
{
	return [UIColor colorWithRed:162.0/255 green:26.0/255 blue:26.0/255 alpha:1];
...
+(UIColor *)highlightOrange;		//	255-140-0	ff8c00	 
{
	return [UIColor colorWithRed:1.0 green:140.0/255 blue:0 alpha:1];
}
