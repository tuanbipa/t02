...
- (void) noteBeginEdit:(NSNotification *)notification
{
    ...
    //noteTextView.frame = CGRectMake(20, 30, 300, 200-30-40);
    
    //[noteView changeFrame:CGRectMake(0, 30, contentView.bounds.size.width, 200-30-40)];
    
    CGFloat h = contentView.bounds.size.height - [Common getKeyboardHeight];
