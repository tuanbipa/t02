...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self = [super initWithFrame:frame]) {
		...
		//todayLine = [[TodayLine alloc] initWithFrame:CGRectMake(0, 0, 320, 8)];
...
- (void) refreshDayManagerView
{
    ...
    dayManagerUpView.frame = CGRectMake(40, 0, 280, y);
    ...
    CGRect frm = CGRectMake(40, y, 280, self.frame.size.height-y);
