...
{
    /*return TASK_EXTRA_STATUS_ASSIGNED_TO_ASSIGNEE | TASK_EXTRA_STATUS_ACCEPTED_BY_ASSIGNEE
    | TASK_EXTRA_STATUS_ASSIGN_TO_ME
    | TASK_EXTRA_STATUS_ASSIGN_TO_OTHER | TASK_EXTRA_STATUS_ACCEPTED_BY_OTHER;*/
    
    return TASK_EXTRA_STATUS_SHARED | TASK_EXTRA_STATUS_ASSIGNED_TO_ASSIGNEE | TASK_EXTRA_STATUS_ACCEPTED_BY_ASSIGNEE
    | TASK_EXTRA_STATUS_ASSIGN_TO_ME
    | TASK_EXTRA_STATUS_ASSIGN_TO_OTHER | TASK_EXTRA_STATUS_ACCEPTED_BY_OTHER;
}
...
{
    return TASK_EXTRA_STATUS_SHARED
...
+ (UIColor *)lighterColorForColor:(UIColor *)c {
    CGFloat lightValue = 0.6;
    CGFloat r, g, b, a;
    if ([c getRed:&r green:&g blue:&b alpha:&a])
        return [UIColor colorWithRed:MIN(r + lightValue, 1.0)
                               green:MIN(g + lightValue, 1.0)
                                blue:MIN(b + lightValue, 1.0)
                               alpha:a];
    return nil;
}
